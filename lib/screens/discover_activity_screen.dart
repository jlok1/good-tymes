...
class DiscoverActivityScreen extends StatefulWidget {
  static const routeName = '/discover-your-activity';
...
class _DiscoverActivityScreenState extends State<DiscoverActivityScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(getText(context).discoverActivities),
      ...
      body: Padding(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .where('createdBy', isNotEqualTo: currentUser!.uid)
              .snapshots(),
          builder:
